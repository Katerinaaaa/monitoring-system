...
public slots:
     ...
     * @param addr IP-адрес студента
     */
    QString wantKeylog(QString addr);
     ...
     * @param filename Название файла политики
     */
    QString showPolitic(QString filename);
     ...
     * @param ip IP-адрес студента
     */
    QString strPolitic(QString politic, QString ip);
